<nav class="navbar navbar-expand-lg navbar-dark mt-2 mb-4 fs-5">
    <div class="container">
        <a class="navbar-brand" href="/">
            <img src="/img/fbox.png" alt="Logo Fbox" width="150" title="Logo Fbox">
        </a>
                            ...
                            <li>
                                <a class="dropdown-item" href="/dashboard">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="currentColor" class="bi bi-layout-text-sidebar-reverse text-dark"
                                        viewBox="0 0 16 16">
                                        <path
                            ...
                            <li>
                                <form action="/logout" method="POST">
                                    ...
                                    <button type="submit" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            fill="currentColor" class="bi bi-box-arrow-right text-dark" viewBox="0 0 16 16">
